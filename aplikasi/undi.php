...
<html lang="en">
    <head>
        ...
        <title>CIU Inventory | Barang Undian</title>
 ...
 <!-- Left Sidebar End -->
	...
	return true;
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Set Barang Undian</b></h4>
                                    <hr/>
                        			...
                        			<div class="row">
                        				<div class="col-md-6">
                        					<form class="form-horizontal" name="category" method="post" action="proses_lelang">
												...
												<div class="form-group">
	                                                <label class="col-md-2 control-label">Keterangan Status Barang</label>
	                                                <div class="col-md-10">
	                                                    <select type="text" class="form-control" name="status_barang_lelang">
															<option value=""> - - Pilih - - </option>
															<option value="Lelang"<?php if ($data['status_barang_lelang']=="Lelang") { echo "selected=\"selected\""; } ?>>Lelang</option>
															<option value="Undian"<?php if ($data['status_barang_lelang']=="Undian") { echo "selected=\"selected\""; } ?>>Undian (Rusak/Lecet/Lain-lain)</option>
												...
												<input type="hidden" class="form-control" name="status_lelang" value="Diundi" required>
											
												<div class="form-group">
                                                    <label class="col-md-2 control-label">&nbsp;</label>
                                                    <div class="col-md-10">
                                                  
                                                <button type="submit" class="btn btn-custom waves-effect waves-light btn-md" name="update_undi">
                                                    Update
                                                </button>
												<a href="manage_barang" onclick="return confirm('Edit Canceled?');"> <i class="btn btn-danger" style="color: #f05050">Cancel</i></a>
                                                    </div>
                                                </div>
