												...
												<div id="accordion">
													...
													<div class="form-group">
														...
														<div id="menuone" class="collapse">
															...
															<button type="submit" class="btn btn-custom waves-effect waves-light btn-md" name="komen">
																Post
															</button>
															<a href="help_req" onclick="return confirm('Kembali ke menu sebelumnya?');"> <i class="btn btn-success" style="color: #f05050">Back</i></a>
																</div>
															</div>
