...
<html lang="en">
    <head>
        ...
        <title>CIU Inventory | Edit Profile</title>
                        				...
                        				<div class="col-md-6">
                        					<form class="form-horizontal" name="category" method="post" action="proses_user">
												...
												<div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                    <input type="text" class="form-control" name="jabatan" value="<?php echo $data['jabatan'];?>" readonly>
                                                ...
                                                <button type="submit" class="btn btn-custom waves-effect waves-light btn-md" name="update_pg">
                                                    Update
                                                </button>
												<a href="manage_profile" onclick="return confirm('Canceled?');"> <i class="btn btn-danger" style="color: #f05050">Cancel</i></a>
                                                    </div>
                                                </div>
