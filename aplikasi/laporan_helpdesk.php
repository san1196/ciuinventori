...
<html lang="en">
    <head>
        ...
        <title>CIU Inventory | Laporan Helpdesk</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Laporan Helpdesk</h4>
...
<?php } ?>
                        			...
                        			<div class="row">
                        				<div class="col-md-6">
                        					<form name='autoSumForm' class="form-horizontal" method="post" action="report_helpdesk" target="_blank">
