...
<p>Pada hari ini, <?php echo hari_ini(); ?>, <?php echo date('d'); ?> <?php echo (ucwords($bulan[date('m')])); ?> <?php echo date('Y'); ?>, Dengan ini mengembalikan barang inventaris IT</p>
<?php
...
<table border="0" width="100%">
<tr>
  <td>Dari<br>Penerima</td>
  <td>: <?php echo $data['dikembalikan_oleh']; ?><br>: IT (<?php echo $data['diterima_oleh']; ?>)</td>
</tr>
</table>
<?php } ?>
<p>Jenis Barang :</p>
...
<table border="0" width="100%">
<tr>
  <th style="width: 33%; text-align: center;">(<?php echo $data['dikembalikan_oleh']; ?>)</th>
...
$pdf->WriteHTML($html);
$pdf->Output('Pengembalian Barang.pdf', 'D');
?>