...
<html lang="en">
    <head>
        ...
        <title>CIU Inventory | Add Pengadaan</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Add Pengadaan</h4>
                        				...
                        				<div class="col-md-8">
                        					<form name='autoSumForm' class="form-horizontal" name="category" method="post" action="proses_pengadaan">
	                                            ...
	                                            <div class="form-group">
	                                                <label class="col-md-4 control-label">No Pengadaan</label>
	                                                <div class="col-md-8">
	                                                    <input type="text" class="form-control" name="no_pengadaan" value="<?php echo $newID2; ?>" readonly>
	                                                </div>
	                                            </div>
												<div class="form-group">
	                                                <label class="col-md-4 control-label">Nama Requester</label>
	                                                <div class="col-md-6">
	                                                    <input class="form-control" type="hidden" name="id_user" id='karyawan' readonly >
														<input class="form-control" type="text" id='nama_karyawan' readonly >
	                                                </div>
													<div class="col-md-2">
														<a href="javascript:void(0);" name="Data Karyawan" title="Data Karyawan" onClick='javascript:window.open("pop_up_req.php","Ratting", "width=700,height=500,left=150,top=200,toolbar=1,status=1,");'><i class="btn btn-primary" style="color: #f05050">Cari</i></a>
													</div>
	                                            </div>
												<div class="form-group">
	                                                <label class="col-md-4 control-label">Tgl Pengadaan</label>
	                                                <div class="col-md-8">
	                                                    <input type="Text" name="tgl_pengadaan" id="demo1"class="form-control" maxlength="25" size="25" img src="../calender/images2/cal.gif" onclick="javascript:NewCssCal('demo1')" style="cursor:pointer" required />
	                                                </div>
	                                            </div>
												...
												<div class="form-group">
	                                                <label class="col-md-4 control-label">Jumlah Pengadaan</label>
	                                                <div class="col-md-8">
												...
												<div class="form-group">
	                                                ...
	                                                <div class="col-md-8">
	                                                    <input type="text" class="form-control" name="harga_pengadaan" onkeypress="return isNumberKey(event)" onFocus="startCalc();" onBlur="stopCalc();" required>
	                                                </div>
	                                            </div>
												<div class="form-group">
	                                                <label class="col-md-4 control-label">Total Harga Pengadaan</label>
	                                                <div class="col-md-8">
	                                                    <input type="text" class="form-control" name="totalharga_pengadaan" onchange='tryNumberFormat(this.form.thirdBox);' onkeypress="return isNumberKey(event)" readonly>
	                                                </div>
	                                            </div>
												<div class="form-group">
												...
												<a href="manage_pengadaan" onclick="return confirm('Canceled?');"> <i class="btn btn-danger" style="color: #f05050">Cancel</i></a>
                                                    </div>
                                                </div>
