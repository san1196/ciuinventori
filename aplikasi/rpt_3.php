...
<br>
<p style="text-align: center">Daftar Pemenang Lelang</p>
<p style="text-align: center">No : DPL/CIU-IT/<?php echo date('d'); ?>/<?php echo date('m'); ?>/<?php echo date('Y'); ?></p>
<br><br><br>

<table border="1">
<tr style="background: blue; font-size: 14px; color: white;">
  <th width="20" style="text-align: center;">No</th>
  <th width="70" style="text-align: center;">ID Lelang</th>
  <th width="160" style="text-align: center;">Penawar</th>
  <th width="180" style="text-align: center;">Nama Barang</th>
  <th width="100" style="text-align: center;">Harga Lelang</th>
...
$sql = mysqli_query($con,"SELECT * FROM penawar WHERE id_penawar IN (SELECT MAX(id_penawar) FROM penawar GROUP BY id_lelang) AND tanggal BETWEEN '$dari' AND '$sampai'");
...
if($row > 0){
    while($data = mysqli_fetch_array($sql)){
        ...
        echo "<td width='70'>".$data['id_lelang']."</td>";
        echo "<td width='160'>".$data['nama_penawar']."</td>";
        echo "<td width='180'>".$data['nama_barang']."</td>";
        echo "<td width='100'>".number_format($data['harga'])."</td>";
