                        			...
                        			<div class="row">
                        				<div class="col-md-6">
                        					...
                        					<form name='autoSumForm' class="form-horizontal" method="post" action="proses_help" enctype="multipart/form-data">
                                                ...
                                                <button type="submit" class="btn btn-custom waves-effect waves-light btn-md" name="submit_adm">
                                                    Submit
                                                </button>
												<a href="dashboard" onclick="return confirm('Canceled?');"> <i class="btn btn-danger" style="color: #f05050">Cancel</i></a>
                                                    </div>
                                                </div>
