...
<html lang="en">
    <head>
        ...
        <title>CIU Inventory | Manage User</title>
...
<td><a href="edit_user?id_user=<?php echo base64_encode($row['id_user']);?>" onclick ="return confirm('Apakah Anda yakin ingin mengubah data?');"><i class="fa fa-pencil" style="color: #29b6f6;"></i></a>
	&nbsp;<a href="proses_user?id_user=<?php echo base64_encode($row['id_user']);?>&&action=del" onclick ="return confirm('Anda yakin ingin menghapus data?');"> <i class="fa fa-trash-o" style="color: #f05050"></i></a> </td>
<?php } ?>
...
<td><?php echo htmlentities($row['jabatan']);?></td>
<td><?php echo htmlentities($row['username']);?></td>
<td><a href="edit_user?id_user=<?php echo base64_encode($row['id_user']);?>" onclick ="return confirm('Apakah Anda yakin ingin mengubah data?');"><i class="fa fa-pencil" style="color: #29b6f6;"></i></a> </td>
<?php } ?>
</tr>
<?php
$cnt++;
