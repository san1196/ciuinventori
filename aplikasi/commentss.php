...
<?php } ?>
                        			...
                        			<div class="row">
                        				<div class="col-md-6">
                        					<form class="form-horizontal" name="category" method="post" action="proses_help" enctype="multipart/form-data">
												<div id="accordion">
													<div class="card">
													...
													<div class="form-group">
														...
														<div id="menuone" class="collapse">
															...
															<button type="submit" class="btn btn-custom waves-effect waves-light btn-md" name="komen_admin">
																Post
															</button>
											...
											<hr>
											<?php
											$query1 = mysqli_query($con,"select * from pesan_helpdesk where id_helpdesk='$id' order by tanggal desc");
											$query2 = mysqli_query($con,"select * from tbl_attachment where id_pesan='$id' order by tanggal desc");
											while($row = mysqli_fetch_array($query1) AND $row2 = mysqli_fetch_array($query2))
												{
		
												echo '<div class="alert alert-success"><b>'.$row['user'].'</b>&emsp;['.$row['permission'].']&emsp;'.$row['tanggal'].'</div>';
												echo '<p>'.$row['komentar'].'</p>';
												echo '<img src="attachments/helpdesk/'.$row2['attachment1'].'" width="50px">&emsp;<img src="attachments/helpdesk/'.$row2['attachment2'].'" width="50px">&emsp;<img src="attachments/helpdesk/'.$row2['attachment3'].'" width="50px">&emsp;<img src="attachments/helpdesk/'.$row2['attachment4'].'" width="50px">&emsp;<img src="attachments/helpdesk/'.$row2['attachment5'].'" width="50px">';
												echo '<hr>';												
												}
											?>
