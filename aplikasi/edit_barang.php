...
<html lang="en">
    <head>
        ...
        <title>CIU Inventory | Edit Barang</title>
 ...
 <!-- Left Sidebar End -->
	...
	return true;
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Edit Barang</b></h4>
                                    <hr/>
                        				...
                        				<div class="col-md-6">
                        					<form name='autoSumForm' class="form-horizontal" method="post" action="proses_barang">
												...
												<div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                    <input type="text" class="form-control" name="stok" onkeypress="return isNumberKey(event)" id="jumlah_pengadaan" value="<?php echo $data['stok'];?>" required>
												...
												<!--
												<div class="form-group">
	                                                <label class="col-md-2 control-label">Keterangan Status Barang Diundi</label>
	                                                <div class="col-md-10">
	                                                    <select type="text" class="form-control" name="status_barang_lelang">
															<option value=""> - - Pilih - - </option>
															<option value="Rusak"<?php if ($data['status_barang_lelang']=="Rusak") { echo "selected=\"selected\""; } ?>>Rusak</option>
															<option value="Lecet"<?php if ($data['status_barang_lelang']=="Lecet") { echo "selected=\"selected\""; } ?>>Lecet</option>
															<option value="Lain-lain"<?php if ($data['status_barang_lelang']=="Lain-lain") { echo "selected=\"selected\""; } ?>>Lain-lain</option>
														</select>
	                                                </div>
	                                            </div>
												-->
