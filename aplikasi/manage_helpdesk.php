...
<html lang="en">
    <head>
        ...
        <title>CIU Inventory | Manage Helpdesk</title>
...
<div class="m-b-30">
												...
												<div class="form-group">
                                                    <table id="example" class="display responsive nowrap" style="width:100%">
                                                        ...
                                                        <tbody>
<?php
$query=mysqli_query($con,"select helpdesk.id_helpdesk, helpdesk.nama, helpdesk.email, helpdesk.divisi, helpdesk.kategori, helpdesk.kategori_ot, helpdesk.status, helpdesk.subject, helpdesk.pesan, helpdesk.tanggal, tbl_attachment.id_helpdesk, tbl_attachment.attachment1, tbl_attachment.attachment2, tbl_attachment.attachment3, tbl_attachment.attachment4, tbl_attachment.attachment5 from tbl_attachment inner join helpdesk on tbl_attachment.id_helpdesk=helpdesk.id_helpdesk order by helpdesk.id_helpdesk desc");
$cnt=1;
...
<td><a href="comments?id_helpdesk=<?php echo base64_encode($row['id_helpdesk']);?>"><u><?php echo htmlentities($row['id_helpdesk']);?></u></a></td>
