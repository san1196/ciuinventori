...
<div class="m-b-30">
												...
												<div class="form-group">
                                                    <table id="example" class="display responsive nowrap" style="width:100%">
                                                        ...
                                                        <tbody>
<?php
$query=mysqli_query($con,"select user.id_user, user.nama_pegawai, pengadaan.id_pengadaan, pengadaan.id_user, pengadaan.no_pengadaan, pengadaan.tgl_pengadaan, pengadaan.nama_barang, pengadaan.jumlah_pengadaan, pengadaan.harga_pengadaan, pengadaan.totalharga_pengadaan, pengadaan.status from pengadaan inner join user on pengadaan.id_user=user.id_user where pengadaan.harga_pengadaan='0' and pengadaan.totalharga_pengadaan='0' order by pengadaan.id_pengadaan desc");
$cnt=1;
...
<td><a href="edit_request?id_pengadaan=<?php echo base64_encode($row['id_pengadaan']);?>" onclick ="return confirm('Apakah Anda yakin ingin mengubah data?');"><i class="fa fa-pencil" style="color: #29b6f6;"></i></a>
...
<td><?php echo htmlentities($row['jumlah_pengadaan']);?></td>
