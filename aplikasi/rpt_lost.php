...
<html>
<head>
  <title>Cetak Kehilangan Barang</title>
...
<br>
<p style="text-align: center">Berita Acara Kehilangan Barang Inventaris IT</p>
<p style="text-align: center">No : LBH/CIU-IT/<?php echo date('d'); ?>/<?php echo date('m'); ?>/<?php echo date('Y'); ?></p>
<p>Pada hari ini, <?php echo hari_ini(); ?>, <?php echo date('d'); ?> <?php echo (ucwords($bulan[date('m')])); ?> <?php echo date('Y'); ?>, Dengan ini menyatakan bahwa telah terjadi kehilangan barang inventaris IT</p>
<?php
...
<table border="0" width="100%">
<tr>
  <td>Peminjam<br>Status Barang</td>
  <td>: <?php echo $data['nama_pegawai']; ?><br>: <?php echo $data['status']; ?></td>
</tr>
</table>
<?php } ?>
<p>Jenis Barang :</p>
...
<table border="0" width="100%">
<tr>
  <th style="width: 33%; text-align: center;">(<?php echo $data['nama_pegawai']; ?>)</th>
...
$pdf->WriteHTML($html);
$pdf->Output('Hilang Barang.pdf', 'D');
?>