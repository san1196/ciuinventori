...
<head>
		<title>Report Helpdesk</title>
		 ...
		 <form method="post" name="form1" action="">
				...
				<h1 align="center">Laporan Request Helpdesk Karyawan</h1>
...
$sql = mysqli_query($con,"SELECT * FROM helpdesk WHERE id_user='$_SESSION[id_user]' AND tanggal BETWEEN '$dari_tgl' AND '$sampai_tgl' order by tanggal desc");
$cnt=1;
