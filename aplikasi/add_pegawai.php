...
<html lang="en">
    <head>
        ...
        <title>CIU Inventory | Add Pegawai</title>
 ...
 <!-- Left Sidebar End -->
	...
	return true;
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Add Pegawai</b></h4>
                                    <hr/>
...
<?php } ?>
	...
	<?php
    $hasil = mysqli_query($con,"select max(id_pegawai) as idMaks from pegawai");
                        			...
                        			<div class="row">
                        				<div class="col-md-6">
                        					<form class="form-horizontal" name="category" method="post" action="proses_pegawai">
												<input class="form-control" type="hidden" name="id_pegawai" value="<?php echo $newID; ?>" readonly ></input>
												...
												<a href="manage_pegawai" onclick="return confirm('Canceled?');"> <i class="btn btn-danger" style="color: #f05050">Cancel</i></a>
                                                    </div>
                                                </div>
