...
<html lang="en">
    <head>
        ...
        <title>CIU Inventory | Edit Request Pengadaan</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Edit Request Pengadaan</h4>
                        				...
                        				<div class="col-md-6">
                        					<form name='autoSumForm' class="form-horizontal" name="category" method="post" action="proses_pengadaan">
												...
												<div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                    <input type="text" class="form-control" name="harga_pengadaan" onkeypress="return isNumberKey(event)" value="<?php echo $data['harga_pengadaan'];?>" onFocus="startCalc();" onBlur="stopCalc();" required>
	                                                </div>
	                                            </div>
												<div class="form-group">
